    ...
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-surface border border-border rounded-lg p-6 flex items-center justify-between">
          <div>
            <h3 className="font-semibold text-white">Ready to code?</h3>
          ...
          <a
            href="/build"
            className="bg-accent text-black px-4 py-2 rounded-lg hover:bg-accent-hover transition font-semibold text-sm flex items-center gap-2"
          >
            Next: Build
